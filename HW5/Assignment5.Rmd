...
## Critical Region    
We are looking for a $\chi_{0.975, 1}^2$ and $\chi_{0.025, 1}^2$, which is equal to `r qchisq(0.975, 1)` and `r round(qchisq(0.025, 1), 4)`.     
...
```{r, message=FALSE, warning=FALSE}
sons_age <- c(22, 23, 25, 22, 24, 23, 23, 24, 31, 32, 33, 34, 35, 36, 37, 22)
fathers_age <- c(23, 24, 24, 25, 25, 24, 24, 23, 31, 32, 33, 34, 35, 36, 37, 19)
